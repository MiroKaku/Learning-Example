...
int main(int, char**)
{
    ...
    WNDCLASSEX wc = { sizeof(WNDCLASSEX), CS_CLASSDC | CS_DROPSHADOW, WndProc, 0L, 0L, GetModuleHandle(NULL), NULL, NULL, NULL, NULL, _T("ImGui Example"), NULL };
    ::RegisterClassEx(&wc);
    HWND hwnd = ::CreateWindowEx(WS_EX_APPWINDOW, wc.lpszClassName, _T("Dear ImGui DirectX9 Example"), WS_POPUP /*| WS_BORDER*/, 200, 200, 780, 500, NULL, NULL, wc.hInstance, NULL);
    ...
    while (msg.message != WM_QUIT)
    {
        ...
        // Sync Window size (同步原生窗口大小)
        RECT rc = { 0 };
        GetWindowRect(hwnd, &rc);
        ImGui::PushStyleVar(ImGuiStyleVar_WindowRounding, 0.0f);
        ImGui::SetNextWindowPos(ImVec2(0.0f, 0.0f), ImGuiCond_Always);
        ImGui::SetNextWindowSize(ImVec2((rc.right - rc.left) * 1.0f, (rc.bottom - rc.top) * 1.0f), ImGuiCond_Always);
        {
            static float f = 0.0f;
            static int counter = 0;
            ImGui::Begin("Hello, world!", &run, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoMove);   // Create a window called "Hello, world!" and append into it.
